...
export type Block = { type: 'text'; text: string } | { type: 'thinking'; text: string } | { type: 'tool_use'; id: string; name: string; input: unknown }
...
export type HistoryItem = { role: 'user'; text: string } | { role: 'assistant'; blocks: Block[] } | { role: 'tool_result'; toolUseId: string; content: string; isError: boolean }
